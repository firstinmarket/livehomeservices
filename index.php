...
<body class="font-poppins bg-gray-50">
    ...
    <header class="sticky top-0 z-50 bg-white shadow-md">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <div class="hidden md:block">
                <a href="tel:+919876543210" class="bg-primary hover:bg-secondary text-white px-6 py-2 rounded-full font-medium transition shadow-md">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="relative">
                <div class="testimonial-carousel flex overflow-x-auto gap-6 pb-6 scrollbar-hide" id="testimonial-carousel">
                    ...
                    <div class="testimonial-card flex-shrink-0 w-full sm:w-2/3 md:w-1/3 bg-white p-6 rounded-xl shadow-sm">
                        <div class="flex items-center mb-4">
                            <div class="w-12 h-12 rounded-full bg-primary bg-opacity-10 flex items-center justify-center mr-4">
                                <i class="fas fa-user text-primary"></i>
                            </div>
                            <div>
                                <h4 class="font-bold text-gray-800">Anand</h4>
                                <p class="text-gray-500 text-sm">Ambattur</p>
                            </div>
                        </div>
                        ...
                        <p class="text-gray-600">
                            "Fixed my fridge in one visit. The technician was professional and quick. The fridge has been working perfectly for months now."
                        </p>
                    </div>
                    ...
                    <div class="testimonial-card flex-shrink-0 w-full sm:w-2/3 md:w-1/3 bg-white p-6 rounded-xl shadow-sm">
                        <div class="flex items-center mb-4">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-800">Priya</h4>
                                <p class="text-gray-500 text-sm">Anna Nagar</p>
                            </div>
                        </div>
                        <div class="flex mb-2 text-yellow-400">
                            <i class="fas fa-star"></i>
                        ...
                        <p class="text-gray-600">
                            "Reliable washing machine repair service. They diagnosed the issue correctly and fixed it at reasonable cost. Very satisfied with their work."
                        </p>
                    </div>
                    ...
                    <div class="testimonial-card flex-shrink-0 w-full sm:w-2/3 md:w-1/3 bg-white p-6 rounded-xl shadow-sm">
                        <div class="flex items-center mb-4">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-800">Ravi</h4>
                                <p class="text-gray-500 text-sm">Kolathur</p>
                            </div>
                        </div>
                        <div class="flex mb-2 text-yellow-400">
                            <i class="fas fa-star"></i>
                        ...
                        <p class="text-gray-600">
                            "AC gas filling done perfectly. The technician explained everything clearly and there were no hidden charges. Will definitely use their service again."
                        </p>
                    </div>
                </div>
    ...
    <section id="contact" class="py-16 bg-gradient-to-r from-green-500 to-green-800 text-white">
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-col lg:flex-row gap-10">
                <div class="lg:w-1/2">
                    <form class="bg-white bg-opacity-10 backdrop-blur-sm p-6 rounded-xl">
                        <div class="mb-4">
                            <label for="name" class="block mb-2 font-medium">Your Name</label>
                            <input type="text" id="name" class="w-full px-4 py-3 rounded-lg bg-green-800 border border-white border-opacity-30 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 placeholder-white placeholder-opacity-70" placeholder="Enter your name">
                        </div>
                        <div class="mb-4">
                            <label for="phone" class="block mb-2 font-medium">Phone Number</label>
                            <input type="tel" id="phone" class="w-full px-4 py-3 rounded-lg bg-green-800 border border-white border-opacity-30 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 placeholder-white placeholder-opacity-70" placeholder="Enter your phone number">
                        </div>
                        <div class="mb-4">
                            <label for="appliance" class="block mb-2 font-medium">Appliance Type</label>
                            <select id="appliance" class="w-full px-4 py-3 rounded-lg bg-green-800 text-white  border border-white border-opacity-30 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 text-white">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="issue" rows="4" class="w-full px-4 py-3 rounded-lg border bg-green-800  border-white border-opacity-30 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 placeholder-white placeholder-opacity-70" placeholder="Briefly describe the problem you're facing"></textarea>
                        </div>
    ...
    <a href="https://wa.me/919876543210" target="_blank" class="fixed bottom-6 right-6 w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-110">
